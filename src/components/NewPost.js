  ...
  return (
    <form onSubmit={handleSubmit}>
      <div style={{justifyContent:"center"}}>
        <textarea style={{border: "3px solid #000", borderRadius: "60px", align: "left", width: "75%", padding: "30px", fontSize: "20px", position: "relative"}}
          value={content}
          onChange={(e) => setContent(e.target.value)}
        ></textarea>
      </div>
      <div style={{alignSelf: "right", position: "relative"}}>
